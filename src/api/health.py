...
import psutil
import os
from .components import ComponentChecker
...
async def health_check():
    ...
    try:
        ...
        # Component status
        components = {
            "database": await component_checker.check_database(),
            "cache": await component_checker.check_cache(),
            "storage": await component_checker.check_storage()
        }
